...
// La silhouette e un parametro, non piu una costante: <Icon ink="#2B1B08" />
// serve sulle schermate a fondo chiaro (la variante youngBg della sfida, 3-4
// anni), dove una silhouette pergamena su crema non si vedrebbe.
...
const WORLD_EMBLEM = {
  foresta: (c, p) => (<>
    <rect x="10.8" y="16.5" width="2.4" height="4.5" rx="1" fill={p} />
    <path d="M12 2.6 L7.6 9 H16.4 Z" fill={p} />
    <path d="M12 6.4 L6.3 13.4 H17.7 Z" fill={p} />
    <path d="M12 10.4 L5 18 H19 Z" fill={p} />
    <circle cx="12" cy="3" r="1.5" fill={c} />
  </>),
  castello: (c, p) => (<>
    <rect x="5" y="12" width="14" height="9" rx="1" fill={p} />
    <rect x="4.6" y="10" width="2.6" height="2.4" fill={p} />
    <rect x="8.6" y="10" width="2.6" height="2.4" fill={p} />
    <rect x="12.8" y="10" width="2.6" height="2.4" fill={p} />
    <rect x="16.8" y="10" width="2.6" height="2.4" fill={p} />
    <rect x="9.6" y="6" width="4.8" height="6" rx="1" fill={p} />
    <rect x="9.3" y="4.6" width="1.6" height="1.8" fill={p} />
    <rect x="13.1" y="4.6" width="1.6" height="1.8" fill={p} />
    <path d="M12 15 q3 0 3 6 H9 q0-6 3-6Z" fill={c} />
    <path d="M12 6 L12 2 L16.5 3.2 L12 4.6Z" fill={c} />
  </>),
  oceano: (c, p) => (<>
    <path d="M3 15 q2.4 -4 4.8 0 q2.4 4 4.8 0 q2.4 -4 4.8 0 q1.2 2 2.4 1.4 L19.8 21 H3 Z" fill={p} />
    <path d="M12 3 C12 3 8 7.5 8 10.4 a4 4 0 0 0 8 0 C16 7.5 12 3 12 3Z" fill={c} />
    <circle cx="10.6" cy="10" r="1.1" fill={p} opacity=".85" />
  </>),
  mercato: (c, p) => (<>
    <rect x="6" y="12" width="12" height="9" rx="1" fill={p} />
    <path d="M4 12 L5.6 6.5 H18.4 L20 12 Z" fill={p} />
  ...
  galassia: (c, p) => (<>
    <circle cx="11" cy="12" r="5.4" fill={p} />
  ...
  vulcano: (c, p) => (<>
    <path d="M4 20 L9 8 h6 l5 12 Z" fill={p} />
  ...
  biblioteca: (c, p) => (<>
    <path d="M12 6.5 C10 5 6.5 5 4.5 6 V19 C6.5 18 10 18 12 19.4 Z" fill={p} />
    <path d="M12 6.5 C14 5 17.5 5 19.5 6 V19 C17.5 18 14 18 12 19.4 Z" fill={p} />
  ...
  laboratorio: (c, p) => (<>
    <path d="M10 3.5 h4 v5 l4 8.2 a2 2 0 0 1 -1.8 3 H7.8 a2 2 0 0 1 -1.8 -3 l4 -8.2 Z" fill={p} />
    <path d="M8.3 14 h7.4 l1.5 3.7 a2 2 0 0 1 -1.8 3 H8.6 a2 2 0 0 1 -1.8 -3 Z" fill={c} opacity=".6" />
    <circle cx="11" cy="17" r="1.1" fill={p} />
    <circle cx="13.6" cy="18.4" r=".9" fill={p} />
    <rect x="9.2" y="2.6" width="5.6" height="1.8" rx=".9" fill={p} />
  </>),
};
...
const GLYPH = {
  lock: (c, p) => (<>
    <rect x="5" y="10.5" width="14" height="10" rx="2.6" fill={p} />
    <path d="M8 10.5 V8 a4 4 0 0 1 8 0 v2.5" fill="none" stroke={p} strokeWidth="2.2" />
  ...
  coin: (c, p) => (<>
    ...
    <circle cx="12" cy="12" r="8.5" fill="none" stroke={p} strokeWidth="1.2" opacity=".5" />
  ...
  flame: (c, p) => (<>
    ...
    <path d="M12 20 C10 19 9.5 16.5 11 14.5 C11.4 16 13 16.4 13 18 A1.6 1.6 0 0 1 12 20Z" fill={p} />
  </>),
  trophy: (c, p) => (<>
    ...
    <rect x="8" y="16" width="8" height="2.4" rx="1" fill={p} />
  </>),
  bulb: (c, p) => (<>
    <circle cx="12" cy="9.5" r="6" fill={GOLD} />
    <rect x="9.4" y="15" width="5.2" height="2" rx="1" fill={p} />
    <rect x="10" y="17.4" width="4" height="2" rx="1" fill={p} />
    <path d="M12 6.5 a3 3 0 0 0 -3 3" fill="none" stroke={p} strokeWidth="1.4" opacity=".7" />
  </>),
  arrowR: (c, p) => (
  ...
  map: (c, p) => (<>
    <path d="M3.5 6.5 L9 4.5 L15 6.5 L20.5 4.5 V17.5 L15 19.5 L9 17.5 L3.5 19.5 Z" fill={p} />
  ...
  wave: (c, p) => (<>
    <path d="M8.6 12.4 V6.4 a1.3 1.3 0 0 1 2.6 0 V10.8 M11.2 10.8 V5.2 a1.3 1.3 0 0 1 2.6 0 V10.8 M13.8 10.8 V6 a1.3 1.3 0 0 1 2.6 0 V11.8 M16.4 11.8 V8.2 a1.3 1.3 0 0 1 2.4 0 v5 a6.2 6.2 0 0 1 -6.2 6.2 a5.6 5.6 0 0 1 -4.3 -2 L5 15 a1.4 1.4 0 0 1 2 -2 l1.6 1.6 Z" fill={p} />
  ...
  cloudSun: (c, p) => (<>
    ...
    <path d="M7.5 18.5 a3.1 3.1 0 0 1 .3 -6.2 a4 4 0 0 1 7.6 1 a2.9 2.9 0 0 1 -.4 5.2 Z" fill={p} />
  </>),
  moon: (c, p) => (<>
    <path d="M15.6 3.6 a8.5 8.5 0 1 0 4.8 15.1 A7 7 0 0 1 15.6 3.6 Z" fill={p} />
  ...
  nightStars: (c, p) => (<>
    ...
    <path d="M6.2 13 l.7 1.5 1.6 .23 -1.15 1.1 .27 1.6 -1.42 -.75 -1.42 .75 .27 -1.6 -1.15 -1.1 1.6 -.23 Z" fill={p} />
  </>),
  bolt: (c, p) => (
    <path d="M13.6 2.5 L5 13.6 h5 l-1.6 7.9 L19 10 h-5.3 Z" fill={c} />
  ),
  school: (c, p) => (<>
    <rect x="5" y="11" width="14" height="10" fill={p} />
    <path d="M12 3.4 L3.2 9.2 h17.6 Z" fill={p} />
  ...
  share: (c, p) => (<>
    <path d="M6 10.5 h2.4 V19 h7.2 V10.5 H18 V21 H6 Z" fill={p} />
  ...
  chart: (c, p) => (<>
    <path d="M4.5 20 H19.5" stroke={p} strokeWidth="2" strokeLinecap="round" />
    <rect x="6" y="12" width="3.2" height="6" rx="1" fill={c} />
    <rect x="10.4" y="8" width="3.2" height="10" rx="1" fill={p} />
    <rect x="14.8" y="5" width="3.2" height="13" rx="1" fill={c} />
  </>),
  music: (c, p) => (<>
    <path d="M9 17 V6 l8.4 -2.1 V15" fill="none" stroke={p} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
  ...
  sparkles: (c, p) => (<>
    ...
    <path d="M17.4 13 l.8 2.2 2.2 .8 -2.2 .8 -.8 2.2 -.8 -2.2 -2.2 -.8 2.2 -.8 Z" fill={p} />
  </>),
  clock: (c, p) => (<>
    <circle cx="12" cy="12" r="8.5" fill={p} />
  ...
  bookmark: (c, p) => (<>
    <path d="M6 3.5 h12 a1.5 1.5 0 0 1 1.5 1.5 V20.5 l-7.5 -4.4 L4.5 20.5 V5 a1.5 1.5 0 0 1 1.5 -1.5 Z" fill={p} />
    <path d="M9 8 h6 M9 11 h4" stroke={c} strokeWidth="1.7" strokeLinecap="round" />
  </>),
  gift: (c, p) => (<>
    <rect x="4.5" y="10.5" width="15" height="9.5" rx="1.4" fill={p} />
    <rect x="3.4" y="7.2" width="17.2" height="3.6" rx="1" fill={p} />
  ...
  famiglia: (c, p) => (<>
    <circle cx="6.9" cy="6.6" r="2.7" fill={p} />
    <circle cx="17.1" cy="6.6" r="2.7" fill={p} />
    <path d="M2 16.6 v-1.7 a4.9 4.9 0 0 1 9.8 0 v1.7Z" fill={p} />
    <path d="M12.2 16.6 v-1.7 a4.9 4.9 0 0 1 9.8 0 v1.7Z" fill={p} />
    <circle cx="12" cy="13.6" r="2.4" fill={c} />
    <path d="M7.6 22.4 v-2 a4.4 4.4 0 0 1 8.8 0 v2Z" fill={c} />
  </>),
  stopads: (c, p) => (<>
    <path d="M3.6 10.2 h3.4 L13.6 5.8 v12.4 L7 13.8 H3.6 a1 1 0 0 1 -1 -1 v-1.6 a1 1 0 0 1 1 -1Z" fill={p} />
    <path d="M16.4 8.6 a4.6 4.6 0 0 1 0 6.8" fill="none" stroke={p} strokeWidth="1.9" strokeLinecap="round" opacity=".5" />
  ...
  dispositivo: (c, p) => (<>
    <rect x="6.4" y="2.4" width="11.2" height="19.2" rx="2.4" fill={p} />
  ...
  piu: (c, p) => (<>
    <circle cx="12" cy="12" r="9.2" fill="none" stroke={p} strokeWidth="2" />
  ...
  mano: (c, p) => (<>
    <path d="M6.5 14.1 a1.75 1.75 0 0 1 2.7 -2.2 l1.1 1.2 V6.2 a1.8 1.8 0 0 1 3.6 0 v4.3 a1.65 1.65 0 0 1 3.3 0 v.6 a1.65 1.65 0 0 1 3.3 0 v4.7 a5.9 5.9 0 0 1 -5.9 5.9 h-1.8 a5.3 5.3 0 0 1 -4.1 -1.9Z" fill={p} />
    <rect x="10.3" y="3.1" width="3.6" height="9.4" rx="1.8" fill={c} />
  </>),
  audio: (c, p) => (<>
    <path d="M3.5 9.6 h3.6 L12.6 5 v14 L7.1 14.4 H3.5 a1 1 0 0 1 -1 -1 v-2.8 a1 1 0 0 1 1 -1Z" fill={p} />
  ...
  uscita: (c, p) => (<>
    <path d="M4 3.6 h9.2 a1 1 0 0 1 1 1 V19.4 a1 1 0 0 1 -1 1 H4Z" fill={p} />
  ...
  seme: (c, p) => (<>
    <path d="M12 21.6 C7.7 21.6 5.1 18 5.1 14.2 C5.1 9.7 8.6 6.1 12 3.2 C15.4 6.1 18.9 9.7 18.9 14.2 C18.9 18 16.3 21.6 12 21.6Z" fill={p} />
    <path d="M12.4 18.8 C10.2 17 9.6 14.1 10.7 11.5" fill="none" stroke={c} strokeWidth="1.9" strokeLinecap="round" />
  </>),
  germoglio: (c, p) => (<>
    <path d="M11.1 21 V12.2 h1.8 V21Z" fill={p} />
    <path d="M11.4 13.4 C8 13.4 5.6 11.4 5.6 8.4 C9 8.4 11.4 10.4 11.4 13.4Z" fill={p} />
    <path d="M12.6 12.6 C12.6 9.2 14.9 6.8 18.4 6.8 C18.4 10.2 16 12.6 12.6 12.6Z" fill={c} />
  </>),
  albero: (c, p) => (<>
    <rect x="10.9" y="15" width="2.2" height="6.2" rx="1" fill={p} />
    <path d="M12 2.6 L7.4 9.4 h9.2Z" fill={p} />
    <path d="M12 7 L5.6 16.4 h12.8Z" fill={p} />
    <circle cx="12" cy="3.4" r="1.6" fill={c} />
  </>),
  insieme: (c, p) => (<>
    <circle cx="7.4" cy="6.4" r="2.9" fill={p} />
    <circle cx="16.6" cy="6.4" r="2.9" fill={p} />
    <path d="M1.9 17.4 v-2 a5.5 5.5 0 0 1 11 0 v2Z" fill={p} />
    <path d="M11.1 17.4 v-2 a5.5 5.5 0 0 1 11 0 v2Z" fill={p} />
    <path d="M12 22.4 c-2.4 -1.7 -4.2 -3.2 -4.2 -5 a2.2 2.2 0 0 1 4.2 -1 a2.2 2.2 0 0 1 4.2 1 c0 1.8 -1.8 3.3 -4.2 5Z" fill={c} />
  </>),
  // ── 5ª tornata: intestazioni dei formati-sfida ──
  matita: (c, p) => (<>
    <path d="M4.4 16.3 L15.9 4.8 l3.3 3.3 L7.7 19.6 l-4.4 1.1Z" fill={p} />
    <path d="M14.4 6.3 l3.3 3.3" stroke="#1B1035" strokeWidth="1.3" opacity=".35" />
    <path d="M16.5 4.2 a2.3 2.3 0 0 1 3.3 3.3Z" fill={c} />
    <path d="M3.3 20.7 l1.1 -4.4 3.3 3.3Z" fill={c} />
  </>),
  lente: (c, p) => (<>
    <circle cx="10.4" cy="10.4" r="6.4" fill="none" stroke={p} strokeWidth="2.2" />
    <circle cx="10.4" cy="10.4" r="4.3" fill={c} opacity=".28" />
    <path d="M15.2 15.2 L20.6 20.6" stroke={c} strokeWidth="2.8" strokeLinecap="round" />
  </>),
  croce: (c, p) => (<>
    <circle cx="12" cy="12" r="9.4" fill={c} />
    <path d="M8.6 8.6 l6.8 6.8 M15.4 8.6 l-6.8 6.8" fill="none" stroke="#3B1120" strokeWidth="2.4" strokeLinecap="round" />
  </>),
  bug: (c, p) => (<>
    <path d="M9.6 5.2 L7.4 2.6 M14.4 5.2 L16.6 2.6" stroke={p} strokeWidth="1.7" strokeLinecap="round" />
    <path d="M6.8 10.6 H3.2 M6.8 14.6 H3.2 M6.8 18 H4 M17.2 10.6 H20.8 M17.2 14.6 H20.8 M17.2 18 H20" stroke={p} strokeWidth="1.7" strokeLinecap="round" />
    <ellipse cx="12" cy="13.6" rx="5.2" ry="6.6" fill={p} />
    <circle cx="12" cy="6.6" r="3.1" fill={p} />
    <circle cx="10.8" cy="6.3" r="1" fill={c} />
    <circle cx="13.2" cy="6.3" r="1" fill={c} />
    <path d="M12 9.4 V19.2" stroke={c} strokeWidth="1.6" strokeLinecap="round" opacity=".75" />
  </>),
  carte: (c, p) => (<>
    <rect x="2.4" y="7.6" width="8.8" height="12.4" rx="1.7" fill={p} opacity=".5"
      transform="rotate(-15 6.8 13.8)" />
    <rect x="10.6" y="4.4" width="10.2" height="15.2" rx="1.9" fill={p}
      stroke="#1B1035" strokeWidth="1.1" />
    <path d="M15.7 8 l1.3 2.6 2.9 .43 -2.1 2.05 .5 2.88 -2.6 -1.36 -2.6 1.36 .5 -2.88 -2.1 -2.05 2.9 -.43Z" fill={c} />
  </>),
  puzzle: (c, p) => (<>
    {/* tacca in alto + bottone a destra: la sagoma classica del pezzo */}
    <path d="M4.4 4.6 H9.2 a2.75 2.75 0 1 0 5.5 0 H19.6 V9.2 a2.75 2.75 0 1 1 0 5.5 V19.6 H4.4 Z" fill={p} />
    <circle cx="10" cy="15.4" r="2.3" fill={c} opacity=".5" />
  </>),
  ricomincia: (c, p) => (<>
    <path d="M20 12 a8 8 0 1 1 -2.65 -5.95" fill="none" stroke={p} strokeWidth="2.4" strokeLinecap="round" />
    <path d="M19.4 2.6 v4.6 h-4.6" fill="none" stroke={c} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
  </>),
};
...
export function SkillIcon({ id, color = GOLD, size = 24, style, ink = PARCH }) {
...
const RANK_EMBLEM = [
  (c, p) => (<> {/* 0 Apprendista — germoglio */}
    <path d="M12 21 V11.5" stroke={p} strokeWidth="2" strokeLinecap="round" />
  ...
  (c, p) => (<> {/* 1 Esploratore — bussola */}
    <circle cx="12" cy="12" r="8.4" fill={p} />
    <path d="M12 6.5 l2.2 5.5 -2.2 5.5 -2.2 -5.5 Z" fill={c} />
    <circle cx="12" cy="12" r="1.2" fill="#241546" />
  </>),
  (c, p) => (<> {/* 2 Avventuriero — spade incrociate */}
    <path d="M4.5 4.5 L15 15 M4.5 4.5 v3 h3" fill="none" stroke={p} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M19.5 4.5 L9 15 M19.5 4.5 v3 h-3" fill="none" stroke={p} strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M5.5 16.5 l3.5 3.5 M18.5 16.5 l-3.5 3.5" stroke={c} strokeWidth="2.3" strokeLinecap="round" />
  </>),
  (c, p) => (<> {/* 3 Stregone — sfera magica */}
    <circle cx="12" cy="9.8" r="6" fill={c} />
    <circle cx="10" cy="7.8" r="1.8" fill={p} opacity=".85" />
    <path d="M6.5 17.5 h11 l-1.8 3 H8.3 Z" fill={p} />
  </>),
  (c, p) => (<> {/* 4 Mago — cappello a punta */}
    <path d="M12 2.5 L5 17.5 h14 Z" fill={p} />
    <path d="M3.8 17.5 h16.4 v2.4 H3.8 Z" fill={p} />
    <path d="M12 8 l.85 2.1 2.15 .3 -1.6 1.5 .42 2.1 -1.82 -1.05 -1.82 1.05 .42 -2.1 -1.6 -1.5 2.15 -.3 Z" fill={c} />
  </>),
  (c, p) => (<> {/* 5 Grande Mago — scintille */}
    <path d="M10 3 l1.35 3.9 3.9 1.35 -3.9 1.35 -1.35 3.9 -1.35 -3.9 -3.9 -1.35 3.9 -1.35 Z" fill={c} />
    <path d="M17 12.5 l.9 2.5 2.5 .9 -2.5 .9 -.9 2.5 -.9 -2.5 -2.5 -.9 2.5 -.9 Z" fill={p} />
  </>),
  (c, p) => (<> {/* 6 Arcimago — stella raggiante */}
    <path d="M12 2 l2.6 6.5 6.9 .5 -5.3 4.4 1.7 6.7 -5.9 -3.7 -5.9 3.7 1.7 -6.7 -5.3 -4.4 6.9 -.5 Z" fill={c} />
    <circle cx="12" cy="11.5" r="1.8" fill={p} opacity=".7" />
  </>),
  (c, p) => (<> {/* 7 Leggenda — coppa */}
    <path d="M7 4 h10 v4 a5 5 0 0 1 -10 0Z" fill={c} />
    <path d="M7 5 H4.5 a2.5 2.5 0 0 0 2.8 4" fill="none" stroke={c} strokeWidth="1.6" />
    <path d="M17 5 H19.5 a2.5 2.5 0 0 1 -2.8 4" fill="none" stroke={c} strokeWidth="1.6" />
    <rect x="11" y="12.5" width="2" height="3.5" fill={c} />
...
export function RankIcon({ level = 0, color = GOLD, size = 24, style, ink = PARCH }) {
  const i = Math.max(0, Math.min(RANK_EMBLEM.length - 1, level | 0));
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} style={style}
      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
      {RANK_EMBLEM[i](color, ink)}
    </svg>
  );
}
